...
/**
 * This class extends the {@link AudioManager} abstract class and uses the JOAL
 * Java interface to OpenAL
 * (http://jogamp.org) to provide a JOAL-based audio manager. This class is
 * responsible for the audio playback
 * of the collection of sounds.
 * <p>
 * <code>JOALAudioManager</code> uses the Inverse Distance Clamped Rolloff model
 * for distance attenuation. The
 * follow is the OpenAL specification's description of this model:
 * <p>
 * <i>
 * This is the Inverse Distance Rolloff Model model, extended to guarantee that
 * for distances below AL_REFERENCE_DISTANCE,
 ...
 * 
 *         Modified from the SAGE Audio package for the RAGE game engine by Juan
 *         E. Ruiz.
 *         Adapted for TAGE by Scott Gordon.
 * 
 * @see <a href=
 *      "http://www.openal.org/documentation/openal-1.1-specification.pdf">OpenAL
 *      Specification</a>
 */
public class JOALAudioManager extends AudioManager {
	...
	/**
	 * Returns the master (global) volume of this {@link AudioManager} by getting
	 * the AL_GAIN from the {@link JOALAudioEar}.
	 */
	...
	/**
	 * Sets the master (global) volume of this {@link AudioManager} by setting the
	 * AL_GAIN for the {@link JOALAudioEar}.
	 */
	...
	/**
	 * Returns a {@link JOALAudioResource} suing the specified sound file and
	 * {@link AudioResourceType}.
	 */
	...
	/**
	 * Returns a new {@link JOALAudioPlayer} after creating it and adding it to the
	 * collection of currently active sounds.
	 */
	...
	/**
	 * Removes the specified {@link IAudioPlayer} from the collection of active
	 * sounds and released the player from memory.
	 */
	...
	/**
	 * Initialize the JOALAudioManager. This includes getting an AL object,
	 * initializes ALUT, creating a JOALAudioEar,
	...
	/**
	 * Returns the equivalent OpenAL boolean value of the passed in Java boolean
	 * value.
	 * 
